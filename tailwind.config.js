  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-3d': '0 25px 50px -12px rgba(255, 0, 110, 0.4)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { filter: "brightness(1) drop-shadow(0 0 20px rgba(255, 0, 110, 0.5))" },
          "50%": { filter: "brightness(1.2) drop-shadow(0 0 40px rgba(255, 0, 110, 0.8))" },
        },
        "rotate-slow": {
